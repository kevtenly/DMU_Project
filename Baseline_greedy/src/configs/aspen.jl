input_config =  InputParameters(
    ...
    ObstacleLocation[ObstacleLocation(3.2,4.1,0.3),ObstacleLocation(2.2,7.5,0.3)], #=obstacles::Array{obstacle_location,1}=#
    4, #=num_humans::Int64=#
    ...
    0.01, #=min_safe_distance_from_obstacle::Float64=#
